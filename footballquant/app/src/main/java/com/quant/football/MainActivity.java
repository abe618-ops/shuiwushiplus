...
public class MainActivity extends Activity {
    ...
    private LinearLayout footballCard(MatchInfo m){
        ...
        DivinationEngine.Bundle d=divination.run(m,day,seed);MultiConsensusEngine.Result mx=multiConsensus.run(m,day,seed,manual);GoalEnsemble.Result g=goals.predict(m,p,null,d,mx);HalfFullEngine.Result hf=halfFull.predict(p);
