...
public class BasketballPredictor {
    ...
    private static double leagueTotal(String s){String x=s==null?"":s.toLowerCase(Locale.US);if(x.contains("nba")&&!x.contains("wnba"))return226;if(x.contains("wnba"))return164;if(x.contains("nbl")||x.contains("australia"))return176;if(x.contains("cba")||x.contains("china"))return174;return168;}
