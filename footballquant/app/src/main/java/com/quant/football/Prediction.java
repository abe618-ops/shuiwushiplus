...
public class Prediction {
    public double home, draw, away, over25, oddGoalsProb;
    ...
    public JSONObject toJson(MatchInfo m){JSONObject o=new JSONObject();try{
        o.put("match",m.toJson());o.put("home",home);o.put("draw",draw);o.put("away",away);o.put("over25",over25);o.put("oddGoalsProb",oddGoalsProb);
